...
public class LayoutService {
    ...
    // tag::getViolations[]
    private JsonArray getViolations(LayoutMap foodItem) {
        Set<ConstraintViolation<LayoutMap>> violations = validator.validate(
        		foodItem);

        JsonArrayBuilder messages = Json.createArrayBuilder();

        for (ConstraintViolation<LayoutMap> v : violations) {
    ...
    public Response add(LayoutMap foodItem) {
        ...
        // tag::getCollection[]
        MongoCollection<Document> Layout = db.getCollection("Layout");
        // end::getCollection[]
    ...
    public Response retrieve() {
        ...
        try {
            ...
            MongoCollection<Document> food = db.getCollection("Layout");
